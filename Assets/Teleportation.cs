...
namespace AG
{
    ...
    {
        [SerializeField] OVRInput.Axis2D stick = default;
        [SerializeField] LineRenderer laser = default;
        ...
        [SerializeField] Transform cameraRig = default;
        [SerializeField] int collisionLayer = default;
